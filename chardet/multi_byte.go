...
type charDecoder_gb18030 struct {
}

func (charDecoder_gb18030) DecodeOneChar(input []byte) (c uint16, remain []byte, err error) {
	if len(input) == 0 {
		return 0, nil, eobError
	}
	first := input[0]
...
var commonChars_gb18030 = []uint16{
...
func newRecognizer_gb18030() *recognizerMultiByte {
	return &recognizerMultiByte{
		"GB18030",
		"zh",
		charDecoder_gb18030{},
